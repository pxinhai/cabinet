...
public class Goodspropertyvalue implements java.io.Serializable {
	...
	public Goodspropertyvalue(int cagetroyPropertyId, int goodsId, String shortStrValue, Date dataChangeCreateTime,
			Date dataChangeLastTime, BigDecimal decimalValue, boolean isDel) {
	...
	public Goodspropertyvalue(int cagetroyPropertyId, int goodsId, String shortStrValue, String longStrValue,
			Date dataChangeCreateTime, Date dataChangeLastTime, BigDecimal decimalValue, boolean isDel) {
		this.cagetroyPropertyId = cagetroyPropertyId;
		this.goodsId = goodsId;
		this.shortStrValue = shortStrValue;

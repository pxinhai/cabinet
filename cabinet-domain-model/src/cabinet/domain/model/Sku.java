...
public class Sku implements java.io.Serializable {
	...
	public Sku(long skuid, int goodsId, int stock, Date dataChangeCreateTime,
	...
	public Sku(long skuid, Integer goodsPropertyValueId, int goodsId,
			int stock, Date dataChangeCreateTime, Date dataChangeLastTime,
			boolean isDel) {
		this.skuid = skuid;
